// CS311: BST header file for HW4 DO NOT CHANGE!!
...
class BST
{
 ...
 protected:   
  ...
  // This should be called whenever a vertex (N) is inserted or
  // whenever a vertex is deleted (i.e. delete V)
